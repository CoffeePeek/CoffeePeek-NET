...
namespace CoffeePeek.Auth.Infrastructure.Migrations
{
    ...
    [Migration("20251222054257_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeePeek.Account.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeePeek.Account.Domain.Entities.UserCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeePeek.Account.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("CoffeePeek.Account.Domain.Entities.UserCredential", "User")
            ...
            modelBuilder.Entity("CoffeePeek.Account.Domain.Entities.User", b =>
                {
                    b.HasOne("CoffeePeek.Account.Domain.Entities.UserCredential", "UserCredential")
                        .WithOne("User")
                        .HasForeignKey("CoffeePeek.Account.Domain.Entities.User", "UserCredentialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoffeePeek.UserService.Models.UserStatistics", b =>
                {
                    b.HasOne("CoffeePeek.Account.Domain.Entities.User", "User")
