    ...
    IPasswordHasherService passwordHasherService) : IUserManager
{
    ...
    public async Task AddToRoleAsync(UserCredential user, string roleName, CancellationToken ct = default)
    {
    ...
    public List<Role> GetRolesAsync(UserCredential user)
    {
        ArgumentNullException.ThrowIfNull(user);
    ...
    public async Task SetAuthenticationToken(UserCredential user, string defaultProvider, string refreshTokenName,
    ...
    public Task<UserCredential?> FindByIdAsync(Guid userId)
    {
        return userRepository.GetByIdAsync(userId);
    }

    public Task<UserCredential?> FindByEmailAsync(string requestEmail)
    {
        return userRepository.GetByEmailAsync(requestEmail);
    }

    public Task RemoveAuthenticationTokenAsync(UserCredential user, string defaultProvider, string refreshTokenName)
    {
    ...
    public RefreshToken? GetAuthenticationToken(UserCredential user, string tokenValue)
    {
    ...
    public Task<bool> CheckPasswordAsync(UserCredential user, string requestPassword)
    {
        ArgumentNullException.ThrowIfNull(user);
