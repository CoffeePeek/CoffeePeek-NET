...
public class JWTTokenService(IUserManager userManager, IOptions<JWTOptions> options) : IJWTTokenService
{
    ...
    public async Task<AuthResult> GenerateTokensAsync(UserCredential user, string deviceName, string ipAddress)
    {
    ...
    private string GenerateJwtAsync(UserCredential user)
    {
