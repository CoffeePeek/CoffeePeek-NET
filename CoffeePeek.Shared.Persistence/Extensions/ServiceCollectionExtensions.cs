...
{
    public static IServiceCollection AddEfCoreData<TDbContext>(this IServiceCollection services, string connectionString,
    ...
    public static IServiceCollection AddGenericRepository<TEntity, TDbContext>(this IServiceCollection services)
        where TEntity : class
        where TDbContext : DbContext
    {
