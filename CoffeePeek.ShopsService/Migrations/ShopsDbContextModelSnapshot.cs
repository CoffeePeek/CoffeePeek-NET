...
namespace CoffeePeek.ShopsService.Migrations
{
    ...
    {
        /// <summary>
        /// Конфигурирует модель Entity Framework Core для ShopsDbContext — регистрирует сущности, их свойства, ключи, индексы, таблицы и отношения между ними.
        /// </summary>
        /// <param name="modelBuilder">Билдер модели EF Core, используемый для описания структуры базы данных и сопоставлений сущностей.</param>
