...
public class GetCommunityFeedHandlerTests
{
    ...
    public async Task Handle_WhenCacheHit_ReturnsCachedResponseWithoutQueryingRepository()
    {
        ...
        _repositoryMock.Verify(
            r => r.GetFeedAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<CommunityFeedFilter>(), _ct),
            Times.Never);
    }
    ...
    public async Task Handle_WhenCacheMiss_QueriesRepositoryCachesAndReturnsPagedResponse()
    {
        ...
        _repositoryMock
            .Setup(r => r.GetFeedAsync(1, 20, CommunityFeedFilter.Reviews, _ct))
    ...
    public async Task Handle_ClampsPageSizeToMaximumOf50()
    {
        ...
        _repositoryMock
            .Setup(r => r.GetFeedAsync(1, 50, CommunityFeedFilter.All, _ct))
            .ReturnsAsync(([], 0));
        ...
        _repositoryMock.Verify(r => r.GetFeedAsync(1, 50, CommunityFeedFilter.All, _ct), Times.Once);
    }
}
